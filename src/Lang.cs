...
namespace Brisk
{
    ...
    public static class L
    {
        ...
        static readonly string[] Pairs =
        {
            ...
            "Kjører deler av Windows i en virtuell maskin. Koster ytelse i alle spill fordi alt går gjennom hypervisoren.", "Runs parts of Windows inside a virtual machine. It costs performance in every game because everything goes through the hypervisor.",
            "Senker sikkerheten reelt. Credential Guard beskytter innloggingene dine mot tyveri.", "Genuinely lowers your security. Credential Guard protects your sign-ins from being stolen.",
            ...
            "Kjernekode kontrolleres av hypervisoren. Merkes mest i spill som belaster prosessoren.", "Kernel code is checked by the hypervisor. Most noticeable in games that lean on the processor.",
            "Senker sikkerheten. Beskytter mot drivere som prøver å kjøre kode i kjernen.", "Lowers your security. It protects against drivers trying to run code in the kernel.",
            "Bakgrunnsopptak", "Background recording",
            "Windows spiller inn spillet ditt hele tiden i tilfelle du vil lagre de siste minuttene. Det koster bilder selv når du aldri lagrer noe.", "Windows records your game continuously in case you want to keep the last few minutes. It costs frames even when you never save anything.",
            "Du mister «ta opp de siste 30 sekundene» i Game Bar.", "You lose “record the last 30 seconds” in Game Bar.",
            "Game Bar", "Game Bar",
            "Overlegget som åpnes med Windows+G. Ligger og lytter etter tastetrykk mens du spiller.", "The overlay that opens with Windows+G. It sits listening for key presses while you play.",
            "Snarveiene for opptak og skjermbilde slutter å virke.", "The recording and screenshot shortcuts stop working.",
            "Maskinvareakselerert GPU-planlegging", "Hardware-accelerated GPU scheduling",
            "Lar skjermkortet styre sin egen minneplanlegging i stedet for Windows.", "Lets the graphics card manage its own memory scheduling instead of Windows.",
            "Ingenting, men effekten varierer. Noen spill vinner, noen taper. Enkelte eldre drivere blir ustabile.", "Nothing, but the effect varies. Some games gain, some lose. A few older drivers become unstable.",
            "Skjermkortet eller driveren støtter ikke dette.", "The graphics card or its driver does not support this.",
            "Strømplan", "Power plan",
            "Balansert lar prosessoren senke klokken mellom bildene. På bærbare og på balansert oppsett er dette ofte det som merkes mest.", "Balanced lets the processor drop its clock between frames. On laptops and on balanced setups this is often the one you notice most.",
            "Mer strøm og mer varme. På bærbar: kortere batteritid.", "More power and more heat. On a laptop: shorter battery life.",
