...
namespace Brisk
{
    ...
    public static class L
    {
        ...
        static readonly string[] Pairs =
        {
            ...
            "{0} startes med denne kommandoen:", "{0} starts with this command:",
            "Den henter kode fra nettet og kjører den med en gang, som administrator. Brisk kan ikke se hva koden gjør før den kjører. Dette er måten laget bak verktøyet selv anbefaler.", "It fetches code from the internet and runs it straight away, as administrator. Brisk cannot see what the code does before it runs. This is the method the tool's own authors recommend.",
