...
namespace VaktmesterSetup
{
    public class SetupForm : Form
    {
        ...
        public SetupForm(bool uninstall)
        {
            ...
            Text = uninstall ? "Avinstaller Vaktmester" : "Installer Vaktmester";
            FormBorderStyle = FormBorderStyle.FixedSingle;
            MaximizeBox = false;
            StartPosition = FormStartPosition.CenterScreen;
            ClientSize = new Size(660, uninstall ? 430 : 528);
            BackColor = Theme.Bg;
        ...
        void Build()
        {
            ...
            lblHead = Theme.Lbl(uninstallMode ? "Avinstaller Vaktmester" : "Vaktmester",
            ...
            primary = new FlatBtn(uninstallMode ? "Avinstaller" : "Installer");
            primary.Primary();
        ...
        void BuildInstallBody()
        {
            ...
            {
                lblSub.Text = "Allerede installert — dette oppdaterer den til versjon " + Setup.Version + ".";
        ...
        async Task Go()
        {
            ...
            lblHead.Text = uninstallMode ? "Avinstallerer …" : "Installerer …";
            lblSub.Text = "";
            ...
            {
                lblHead.Text = "Vaktmester er fjernet";
                lblSub.Text = "Takk for lånet.";
                primary.Text = "Lukk";
            }
            else
            {
                lblHead.Text = "Ferdig installert";
